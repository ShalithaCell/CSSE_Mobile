...
////                             no = (List<AddItemsForOrder>) task.getResult().getDocuments().get("");
////                             addDetails();
////                        } else {
////
////                        }
...
////
////        View cardView = getLayoutInflater().inflate(R.layout.additemcardview,null,false);
////
////        MaterialSpinner spinner = (MaterialSpinner)cardView.findViewById(R.id.spinner);
////        spinner.setItems(no);
////
